  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-white selection:text-black font-['Inter'] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 w-full z-[100] no-print border-b border-white/5 bg-black/80 backdrop-blur-xl flex items-center justify-between px-4 md:px-16 h-20 md:h-24">
        ...
        <div className="lg:hidden flex items-center overflow-x-auto no-scrollbar py-2 max-w-[60%] border-l border-white/10 ml-2 gap-2">
          <NavButton id="summary" label="Summary" active={activeSection === 'summary'} />
          <NavButton id="experience" label="Work" active={activeSection === 'experience'} />
          <NavButton id="education" label="Education" active={activeSection === 'education'} />
          <NavButton id="skills" label="Skills" active={activeSection === 'skills'} />
        ...
        <section className="min-h-[80vh] flex flex-col justify-center px-8 md:px-16">
          <header className="max-w-7xl mx-auto w-full text-center md:text-left">
            ...
            <div className="flex flex-col md:flex-row justify-center md:justify-start gap-8 md:gap-32">
              ...
              <div className="flex flex-col">
                <span className="text-zinc-500 text-[10px] font-bold tracking-[1em] uppercase mb-4">Network</span>
                <a href={data.contact.linkedin} target="_blank" rel="noreferrer" className="text-xl md:text-2xl font-light uppercase tracking-widest text-zinc-400 hover:text-white transition-all underline decoration-zinc-800 underline-offset-[16px]">
                  LINKEDIN
                </a>
              </div>
            </div>
